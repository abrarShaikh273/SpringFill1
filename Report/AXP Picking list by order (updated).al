report 50103 "Picking List by Order Updated"
{
    // version NAVNA11.00

    DefaultLayout = RDLC;
    RDLCLayout = './Picking List by Order test.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(LocationLoop; Integer)
            {
                ...
                dataitem(CopyNo; Integer)
                {
                    ...
                    dataitem(PageLoop; Integer)
                    {
                        ...
                        column(ShippingAgent_Name; ShippingAgent_Name)
                        {
                        }
                        ...
                        column(ShippingAgent_NameCaption; ShippingAgentName_CaptionLbl)
                        {
                        }
                        ...
                        dataitem("Sales Line"; "Sales Line")
                        {
                            ...
                            dataitem("Tracking Specification"; "Tracking Specification")
                            {
                                ...
                                DataItemTableView = SORTING("Source ID", "Source Type", "Source Subtype", "Source Batch Name", "Source Prod. Order Line", "Source Ref. No.")
                        ...
                        dataitem("Sales Comment Line"; "Sales Comment Line")
                        {
                            ...
                            DataItemTableView = SORTING("Document Type", "No.", "Document Line No.", "Line No.")
                                                WHERE("Document Type" = CONST(Order),
                                                      "Print On Pick Ticket" = CONST(true));
            ...
            begin
                ...
                CLEAR(ShippingAgent_Name);
                IF ShippingAgent.GET("Sales Header"."Shipping Agent Code") THEN
                    ShippingAgent_Name := ShippingAgent.Name;
    ...
    var
        ...
        Picking_List_by_OrderCaptionLbl: TextConst ENU = 'Picking List by Order', ESM = 'List. picking por ped.', FRC = 'Bon de cueillette par commande', ENC = 'Picking List by Order';
